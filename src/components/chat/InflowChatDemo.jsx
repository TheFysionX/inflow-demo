...
export default function InflowChatDemo(props) {
    ...
    const DEMOS = React.useMemo(() => ({
        day_trading: {
            ...
            intro: "This is a **demo conversation** built around a sample day trading course and the information this assistant is meant to collect. To get the clearest feel for the AI's behavior, try the conversation as a realistic prospective customer and test different situations.",
            canned: [
                {
        ...
        fitness_health: {
            ...
            intro: "This is a **demo conversation** built around a sample fitness coaching offer and the information this assistant is meant to collect. To get the clearest feel for the AI's behavior, try the conversation as a realistic prospective customer and test different situations.",
            canned: [
                {
        ...
        self_improvement: {
            ...
            intro: "This is a **demo conversation** built around a sample self-improvement coaching offer and the information this assistant is meant to collect. To get the clearest feel for the AI's behavior, try the conversation as a realistic prospective customer and test different situations.",
            canned: [
                {
